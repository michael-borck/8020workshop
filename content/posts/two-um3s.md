...
Both machines are dusty but structurally solid. The Ultimaker 3 uses a composite panel frame, not thin aluminium extrusions, so there's no rack or twist even after years of storage and a car ride home. Both boot. Both heat beds and hotends. Both home all axes. The mechanical nozzle lift — where the inactive nozzle physically clicks up on a spring-loaded hinge — works perfectly on both.
...
*Next up: the full teardown — rod polishing, PVA blob removal, firmware updates, and the first dual-extrusion print.*
